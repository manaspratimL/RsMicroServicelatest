package com.rs.ms.in.subscription;
...
public class InstagramSubscriptionService {
		 ...
		 * Default constructor
		 */
		public InstagramSubscriptionService() {
		 ...
		 * @return the {@link InstagramSubscriptionService} instance for method chaining
		 */
		public InstagramSubscriptionService callback(String callback) {
		 ...
		 * @return the {@link InstagramSubscriptionService} instance for method chaining
		 */
		public InstagramSubscriptionService clientId(String clientId) {
		 ...
		 * @return the {@link InstagramSubscriptionService} instance for method chaining
		 */
		public InstagramSubscriptionService clientSecret(String clientSecret) {
		 ...
		 * @return the {@link InstagramSubscriptionService} instance for method chaining
		 */
		public InstagramSubscriptionService object(String type) {

			this.params.put(Constants.SUBSCRIPTION_TYPE, type);
	     ...
	     * @return the {@link InstagramSubscriptionService} instance for method chaining
	     */
	    public InstagramSubscriptionService objectId(String objectId) {
	     ...
	     * @return the {@link InstagramSubscriptionService} instance for method chaining
	     */
		public InstagramSubscriptionService verifyToken(String verifyToken) {
		 ...
		 * @return the {@link InstagramSubscriptionService} instance for method chaining
		 */
		public InstagramSubscriptionService aspect(String aspect) {
		 ...
		 * @return the {@link InstagramSubscriptionService} instance for method chaining
		 */
		public InstagramSubscriptionService latitute(String latitude){
		 ...
		 * @return the {@link InstagramSubscriptionService} instance for method chaining
		 */
		public InstagramSubscriptionService longitude(String longitude){
		 ...
		 * @return the {@link InstagramSubscriptionService} instance for method chaining
		 */
		public InstagramSubscriptionService radius(String radius){
		 ...
		 */
		public InstagramSubscriptionService requestConfiguration(final InstagramConfig config){
			if(config != null) {
				this.config = config;
			}
			return this;
	    ...
	    public String toString() {
	        ...
	        builder.append("InstagramSubscriptionService [");
